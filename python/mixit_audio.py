...
parser.add_argument("--output_folder", type=str, default = 'output', const = 'output',
    nargs='?',help="the folder to save the files")
# parse the arguments
...
--output {output_file}"
    os.system(cmd)
    print('brought over')
    print(os.path.join(output_folder, basename, name_without_ext, os.path.basename(input_file)))
